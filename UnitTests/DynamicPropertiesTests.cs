...
namespace JUST.UnitTests
{
    ...
    {
        // [TestCase("\"is red\"", "\"is red\"")]  // Quoted string unsupported
        [TestCase(true, "true")]
        [TestCase(12.2, "12.2")]
        [TestCase(null, "null")]
        ...
        public void Eval(object val, object result)
        {
            ...
            var actual = new JsonTransformer(new JUSTContext() { EvaluationMode = EvaluationMode.Strict}).Transform(transformer, input);
